...
<html>
<head>
	<title>S2P2 General Store | Contact </title>
			...
			<div class="row contact-grids agile-1 mb-5">
				<div class="col-sm-4 contact-grid agileinfo-6 mt-sm-0 mt-2">
					<div class="contact-grid1 text-center">
						...
						<p style="font-weight: bold;color:black;">S2P2 General Store
							<label style="font-weight: bold;color:black;">Shop No.4 Building No.51/B Vijaynagar,Bangalore-560091</label>
						</p>
					</div>
				</div>
				<div class="col-sm-4 contact-grid agileinfo-6 my-sm-0 my-4">
					<div class="contact-grid1 text-center">
						...
						<p style="font-weight: bold;color:black;"><a style="font-weight: bold;color:black;" href="tel:+919535641238">+(91) 9535641238</a>
...
<!-- 							<label>+(91) 121 122 000</label> -->
				...
				<div class="col-sm-4 contact-grid agileinfo-6">
					<div class="contact-grid1 text-center">
						...
						<p>
							<a style="font-weight: bold;color:black;" href="mailto:s2p2stores@gmail.com">s2p2stores@gmail.com</a>
						</p>
					</div>
				</div>
			</div>

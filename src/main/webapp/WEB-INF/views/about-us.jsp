...
<html>
<head>
	<title>S2P2 General Store | About </title>
		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="row">
				<div class="col-lg-6 welcome-left">
					<h3>About Store</h3>
					<h4 class="my-sm-3 my-2">GrocSMART(S2P2 General Store) is a low-price online Grocery store, which has many vital ranging products consumed in our everyday Breakfast, Meals & Dinners. We have Fresh Vegetables, Staples, Beverages, Personal care products & many other products needed daily. All the products on our
